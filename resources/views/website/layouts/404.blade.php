  ...
  <body>
    <div class="start-page" role="main">
      ...
      <div class="no-found"><img class="img-responsive" src="../images/schedule.svg">
        <h3 class="text-uppercase">Sorry, !This page could not be found</h3>
        <p class="text-capitalize">We are sorry. But the page you are looking for is not available</p><a class="btn btn-custom text-uppercase" href="http://localhost/cars/dist/html/">go home <i class="fa fa-home"></i></a>
      </div>
      <!-- End of start Page-->
