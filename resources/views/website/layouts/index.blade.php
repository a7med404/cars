            ...
            <div class="tabs">
              ...
              <div class="tab-content sections-contents" id="pills-tabContent">
                <div class="tab-pane fade active in" id="pills-sell" role="tabpanel" aria-labelledby="pills-sell-tab">
                  <div class="cars-list scale">
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="car-card text-center">
                          <div class="car-img"><img class="img-responsive" src="../images/cool (338).jpg"></div>
                          <div class="detail">
                            ...
                            <ul class="list-unstyled">
                              ...
                              <button class="btn btn-custom text-uppercase">read more <i class="fa fa-chevron-left"></i></button></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="car-card text-center">
                          <div class="car-img"><img class="img-responsive" src="../images/logos-background.jpg"></div>
                          <div class="detail">
                            <p class="time">5 minute a go</p>
                            <h3 class="text-uppercase">car title name</h3><span class="price"><a>$35,50 </a></span><span class="kilo"><a>50,000 KM <i class="fa fa-home"></i></a></span>
                            <ul class="list-unstyled">
                    ...
                    <div class="row">
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="car-card text-center">
                          <div class="car-img"><img class="img-responsive" src="../images/cool (302).jpg"></div>
                          <div class="detail">
                            <p class="time">5 minute a go</p>
                            <h3 class="text-uppercase">car title name</h3><span class="price"><a>$35,50 </a></span><span class="kilo"><a>50,000 KM <i class="fa fa-home"></i></a></span>
                            <ul class="list-unstyled">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="car-card text-center">
                          <div class="car-img"><img class="img-responsive" src="../images/auto-racing-automobiles-automotive-39855.jpg"></div>
                          <div class="detail">
                            <p class="time">5 minute a go</p>
                            <h3 class="text-uppercase">car title name</h3><span class="price"><a>$35,50 </a></span><span class="kilo"><a>50,000 KM <i class="fa fa-home"></i></a></span>
                            <ul class="list-unstyled">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="car-card text-center">
                          <div class="car-img"><img class="img-responsive" src="../images/cool (92).jpg"></div>
                          <div class="detail">
                            <p class="time">5 minute a go</p>
                            <h3 class="text-uppercase">car title name</h3><span class="price"><a>$35,50 </a></span><span class="kilo"><a>50,000 KM <i class="fa fa-home"></i></a></span>
                            <ul class="list-unstyled">
                ...
                <div class="tab-pane fade" id="pills-rent" role="tabpanel" aria-labelledby="pills-rent-tab"> 
                  <div class="no-found"><img class="img-responsive" src="../images/schedule.svg">
                    <h3 class="text-uppercase">sell with best price</h3>
                  </div>
                </div>
              </div>
        ...
        <div class="layout">
          <div class="container">
            <div class="text-center scale">
              ...
              <ul class="list-unstyled">
                <li><a><img class="img-responsive" src="../images/mercedes-benz.svg"></a></li>
                <li><a><img class="img-responsive" src="../images/honda.svg"></a></li>
                <li><a><img class="img-responsive" src="../images/chevrolet.svg"></a></li>
                <li><a><img class="img-responsive" src="../images/hyundai.svg"></a></li>
                <li><a><img class="img-responsive" src="../images/toyota.svg"></a></li>
              </ul>
            ...
            <div class="testimonial">
              <div class="div carousel slide" data-ride="carousel" id="quote-carousel">
                ...
                <ol class="carousel-indicators">
                  <li class="active" data-target="#quote-carousel" data-slide-to="0"> <img class="img-fluid img-circle img-responsive" src="https://s3.amazonaws.com/uifaces/faces/twitter/mantia/128.jpg" alt=""></li>
                  <li data-target="#quote-carousel" data-slide-to="0"> <img class="img-responsive" src="https://s3.amazonaws.com/uifaces/faces/twitter/mantia/128.jpg" alt=""></li>
                  <li data-target="#quote-carousel" data-slide-to="0"> <img class="img-fluid img-responsive" src="../images/profile-image.jpg" alt=""></li>
