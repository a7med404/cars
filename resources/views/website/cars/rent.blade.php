                            ...
                            <table class="table table-striped table-bordered table-hover" id="table_id">
                                ...
                                <tbody>
                                    @foreach($cars as $car)
                                        <tr class="odd gradeX"> 
                                            <td>{{ $car->id }}</td>
                                            <td><a href="{{ route('cars.show', ['id' => $car->id]) }}">{{ $car->name." SD" }}</a></td>
                                            <td><a href="{{ route('cars.show', ['id' => $car->id]) }}">{{ $car->for_sale_rent }}</a></td>
                                            ...
                                            <td><a class="{{ toggleOneZeroClass()[$car->visibility] }}" href="{{ route('cars.show', ['id' => $car->id]) }}">{{ visibility()[$car->level] }}</a></td>
