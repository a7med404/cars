...
@section('page-content-header')
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-laptop"></i> Site Settings </h3>
      <ol class="breadcrumb">
...
<div class="">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          {!! Form::open(['route' => ['site-setting-update'], 'method' => "POST", 'file' => true]) !!}
          @foreach($stieSetting as $setting)
            <div class="form-group">
              <div class="row">
                <label for="{{ $setting->name_setting }}" class="col-md-4 col-sm-12 col-form-label text-md-right">{{ $setting->slug }}</label>
