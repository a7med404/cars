                            ...
                            <table class="table table-striped table-bordered table-hover" id="table_id">
                                ...
                                <tbody>
                                    @foreach($customers as $customer)
                                            ...
                                            <td><a href="{{-- route('search',['is_dealer' => $customer->is_dealer]) --}}" class="{{ toggleOneZeroClass()[$customer->is_dealer] }}">{{ isAegnt()[$customer->is_dealer] }}</a></td>
                                            <td><a href="{{-- route('search',['status' => $customer->status]) --}}" class="{{ toggleOneZeroClass()[$customer->status] }}">{{ status()[$customer->status] }}</a></td>
                                            <td><a href="{{ route('customers.show', ['id' => $customer->id]) }}" class="badge bg-main-color">{{ $customer->cars->count() }}</td>
                                            <td>
                                                <div class="btn-group">
